...
// Modifications for "dead bug" style connection of rotary encoder
// to an arduino micro - soldered directly to the pins indicated
//
// bob murphy thisoldgeek.blogspot.com 05/17/2014
//
#define BUTTON_PIN A5 
#define KNOB_QUAD_LEFT 4  // VOLUME UP
#define KNOB_QUAD_RIGHT 6  // VOLUME DOWN
#define KNOB_QUAD_GND 5
#define BUTTON_GND A3  
...
void setup() {
  ...
  pinMode(KNOB_QUAD_GND, OUTPUT);
  pinMode(BUTTON_GND, OUTPUT);
  
  
  // turn on pullup resistors
  digitalWrite(BUTTON_PIN, HIGH);
  digitalWrite(BUTTON_GND, LOW);   // Emulate GND
  digitalWrite(KNOB_QUAD_LEFT, HIGH);
  digitalWrite(KNOB_QUAD_RIGHT, HIGH);
  digitalWrite(KNOB_QUAD_GND, LOW);  // Emulate GND
